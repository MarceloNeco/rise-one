...
| Segunda vista dos movimentos | Gerada a partir do desenho original, por regra geométrica | Girar o observador 90° não muda a altura de nenhuma articulação: os `y` são os mesmos do desenho já existente |
